...
import SimpleShoppingCart from "./components/simpleShoppingCart/SimpleShoppingCart";
  ...
  return (
    <Box>
      <PageHeading
        ...
        description="Components for displaying a shopping cart for your application"
      />
      <MainComponentBlock
